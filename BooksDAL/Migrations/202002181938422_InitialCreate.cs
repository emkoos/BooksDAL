    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        CartPostionId = c.Int(nullable: false, identity: true),
                        Quantity = c.Int(nullable: false),
                        Value = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Timestamp = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"),
                        Product_ProductId = c.Int(),
                    })
                .PrimaryKey(t => t.CartPostionId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CartPositions", "Product_ProductId", "dbo.Products");
            DropForeignKey("dbo.Products", "CategoryId", "dbo.Categories");
            DropIndex("dbo.OrderPositions", new[] { "ProductId" });
            DropIndex("dbo.OrderPositions", new[] { "OrderId" });
            DropIndex("dbo.Products", new[] { "CategoryId" });
            DropIndex("dbo.CartPositions", new[] { "Product_ProductId" });
            DropTable("dbo.Users");
            DropTable("dbo.Orders");
            DropTable("dbo.OrderPositions");
            DropTable("dbo.Categories");
            DropTable("dbo.Products");
            DropTable("dbo.CartPositions");
        }
    }
}
